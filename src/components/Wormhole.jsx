      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: isMobile ? "1rem" : "1.5rem", lineHeight: "1.5" }}>
            Wrapped $ZHOA (wZHOA) is officially live on Raydium DEX on the Solana blockchain. That’s right—you can now
            trade, hold, and expand your $ZHOA journey across chains, using Solana’s lightning-fast ecosystem and the
            ever-popular Phantom wallet.
          </p>
          ...
          >
            <a
              href="https://portalbridge.com/advanced-tools/#/tranfer"
              target="_blank"
            ...
            <a
              href="https://dexscreener.com/solana/eatsxlm7hgjv8xpqxrdqyqmcojpn2nyweygqzq52zyjb"
              target="_blank"
              rel="noopener noreferrer"
              style={buttonStyle}
            >
