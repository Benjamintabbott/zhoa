...
const TOKEN_ADDRESS = "0xC3571b3f9721D07919dc42af7fce2784B56e8E3c"; // Your token contract address
      ...
      >
        ...
        >
          {[
            ...
            { label: "Market Cap", value: marketData.marketCap },
            { label: "24h Volume", value: marketData.volume },
            { label: "24h Change", value: `${marketData.priceChange}%`, color: marketData.priceChange < 0 ? "#ff4444" : "#44ff44" },
            { label: "Holders", value: "4,500+" },
